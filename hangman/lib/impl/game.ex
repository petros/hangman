defmodule Hangman.Impl.Game do
  ...
  @spec new_game() :: t()
  def new_game() do
    Dictionary.Impl.WordList.word_list()
    |> Dictionary.Impl.WordList.random_word()
    |> new_game()
  end
  ...
  def tally(game) do
    %{
      ...
      letters: return_guessed_letters(game),
  ...
  defp return_guessed_letters(game = %{game_state: :lost}) do
    game.letters
  end

  defp return_guessed_letters(game) do
    game.letters
